...
*/
  const [state, setState] = React.useEffect({
    pokemon: null,
    error: null,
    status: 'edle'
  })

  //Criando variáveis avulsas somente-leitura para facilitar o trabalho com variável de estado objeto
  ...
  React.useEffect(() => {
    ...
    fetchPokemon(pokemonName).then( // Deu certo
      pokemonData => {
        ...
        ///let stateTemp = {...status} //Copia o objeto state
